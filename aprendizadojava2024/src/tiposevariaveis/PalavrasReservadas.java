...
public class PalavrasReservadas {
	 ...
	 * 
	 * Modificadores de classes, variáveis ou métodos abstract: classe que não pode
	 * ser instanciada ou método que precisa ser implementado por uma subclasse não
	 * abstrata
	 * 
	 ...
	 * 
	 * static: faz um método ou variável pertencer à classe ao invés de às
	 * instâncias
	 * 
	 * strictfp: usado em frente a um método ou classe para indicar que os números
	 * de ponto flutuante seguirão as regras de ponto flutuante em todas as
	 * expressões
	 * 
	 ...
	 * 
	 * Controle de fluxo dentro de um bloco de código break: sai do bloco de codigo
	 * em que ele está
	 * 
	 ...
	 * 
	 * default:executa esse bloco de codigo caso nenhum dos teste de switch-case
	 * seja verdadeiro
	 * 
	 ...
	 * verdadeira
	 * 
	 * Tratamento de erros assert: testa uma expressão condicional para verificar
	 * uma suposição do programador
	 * 
	 ...
	 * chamou
	 * 
	 * try: bloco de código que tentará ser executado, mas que pode causar uma
	 * exceção
	 * 
	 ...
	 * 
	 * Primitivos boolean:um valor indicando verdadeiro ou falso
	 * 
	 ...
	 * 
	 * Variáveis de referência super: refere-se a superclasse imediata
	 * 
	 * this: refere-se a instância atual do objeto
	 * 
	 * Retorno de um método void: indica que o método não tem retorno
	 * 
	 * Palavras reservadas não utilizadas const: Não utilize para declarar
	 * constantes; use public static final
	 * 
	 * goto: não implementada na linguagem Java por ser considerada prejudicial
	 * 
	 * Literais reservados De acordo com a Java Language Specification, null, true e
	 * false são tecnicamente chamados de valores literais, e não keywords. Se você
	 * tentar criar algum identificador com estes valores, você também terá um erro
	 * de compilação.
	 * 
	 * 
	 */
